        ...
        <NavLink to={`/news/${data.news_id}`}>
            <div className='fullwidth'>
                <div className='fullwidth__head'>
                    ...
                    <p className='fullwidth__head-title'>{lang === 'uz' ? data.title_uz : data.title_ru}</p>
                    <div className='fullwidth__head-infos'>
                        <p className='time'>{data.created_at}</p>
                    </div>
                </div>
                <div className='fullwidth__body'>
                    <p className='fullwidth__body-title'>{lang === 'uz' ? data.full_description_uz : data.full_description_ru}</p>
                </div>
            </div>
        </NavLink>
    )
